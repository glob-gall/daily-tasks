...
const pixKey =
  "00020126360014br.gov.bcb.pix0114+55499910752835204000053039865802BR5925Luis Felipe Galleguillos 6009Sao Paulo62070503***6304A6BB";
  ...
  return (
    <Base>
      <Margin>
        <S.Container>
          <S.PixContainer>
            <S.PixImage source={qrcode} resizeMode="contain" />
          </S.PixContainer>

          <S.PixCopiCola onPress={copyPixKey}>
            <S.TextsContainer>
              <S.PixLabel>Pix Copia e Cola</S.PixLabel>
              <S.PixCopiColaText>{pixKey}</S.PixCopiColaText>
            </S.TextsContainer>
            <S.CopyPasteIcon>
